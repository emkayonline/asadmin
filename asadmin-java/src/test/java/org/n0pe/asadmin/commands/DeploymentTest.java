...
public class DeploymentTest
    ...
    public void testDeploy() {
        ...
        goodParams = new String[]{AsAdmin.ASADMIN_COMMAND_NAME,
                                  ...
                                  AsAdmin.PASSWORDFILE_OPT, TestAsConfigProvider.PASSWORD_FILE, deployCmd.getActionCommand(),
    ...
    public void testUndeploy() {
        ...
        goodParams = new String[]{AsAdmin.ASADMIN_COMMAND_NAME, 
                                  ...
                                  AsAdmin.PORT_OPT, TestAsConfigProvider.PORT,
                                  AsAdmin.USER_OPT, TestAsConfigProvider.USER_NAME,
                                  AsAdmin.PASSWORDFILE_OPT, TestAsConfigProvider.PASSWORD_FILE,undeployCmd.getActionCommand(),
                                  COMPONENT_NAME
                };
